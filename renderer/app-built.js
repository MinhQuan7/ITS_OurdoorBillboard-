      ...
      [
        React.createElement("div", {
          ...
          style: {
            ...
            bottom: 0,
            background:
              "linear-gradient(135deg, rgba(30, 58, 95, 0.85) 0%, rgba(44, 82, 130, 0.75) 50%, rgba(26, 54, 93, 0.85) 100%)",
            zIndex: 1,
          },
        }),
        React.createElement(
                    ...
                    [
                      React.createElement("div", {
                        ...
                        style: {
                          ...
                          justifyContent: "center",
                          filter:
                            "drop-shadow(0 4px 8px rgba(0, 0, 0, 0.5)) sepia(100%) saturate(200%) hue-rotate(30deg) brightness(1.3)",
                          color: "#FFD700",
                          flexShrink: 0,
                        },
...
class EraIotService {
  ...
  async startPeriodicUpdates() {
    ...
    console.log(
      "EraIotService: Started periodic updates every 1 second for real-time data"
    );
  }
  ...
  if (isLoading && !sensorData) {
    return React.createElement(
      ...
      [
        ...
        React.createElement(
          "div",
          { key: "loading", style: { fontSize: "10px", color: "#888" } },
          "Đang kết nối..."
        ),
      ]
    );
  ...
  if (!eraIotService || (!sensorData && connectionStatus === "error")) {
    return React.createElement(
      ...
      [
        ...
        React.createElement(
          "div",
          { key: "error", style: { fontSize: "10px", color: "#ff4444" } },
  ...
  if (!sensorData) {
    return React.createElement(
      ...
      [
        ...
        React.createElement(
          "div",
          { key: "offline", style: { fontSize: "10px", color: "#888" } },
          "Không có dữ liệu"
        ),
      ]
    );
    ...
    [
      ...
      React.createElement(
        ...
        [
          React.createElement(
            "div",
            { key: "title", style: { fontSize: "12px", fontWeight: "bold" } },
            "CẢM BIẾN IOT"
          ),
          React.createElement("div", {
            key: "status",
